...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('public/backend/plugins/toastr/toastr.css') }}">
    <link rel="stylesheet" href="{{ asset('public/backend') }}/dist/css/tagsinput.css">
   <!-- summernote -->
...
<!-- PAGE PLUGINS -->
<script src="{{ asset('public/backend') }}/dist/js/tagsinput.js"></script>
<!-- jQuery Mapael -->
...
<script src="{{ asset('public/backend') }}/jquery_chained/jquery.chained.min.js"></script>
<script src="{{ asset('public/backend') }}/jquery_chained/jquery.chained.js"></script>
<script src="{{ asset('public/backend') }}/jquery_chained/jquery.chained.remote.js"></script>
<script src="{{ asset('public/backend') }}/jquery_chained/jquery.chained.remote.min.js"></script>
...
<script>
  $(function () {
    ...
    }).buttons().container().appendTo('#example1_wrapper .col-md-6:eq(0)');F
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
