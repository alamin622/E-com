                   ...
                   @foreach($data as $key=>$row)
                    <tr>
                      ...
                      <td>{{ $row->category_slug }}</td>
                        <td> <img style="width: 60px"; height="60px" src="{{$row->image}}"></td>
                        <td> <img style="width: 40px"; height="40px" src="{{$row->icon}}"></td>
                        <td class="">
                            @if ($row->home_page ==1)
                             <span href="#" class="badge badge-success" >  Home Page </span>
                            @else
                             <span href="#" class="badge btn badge-danger">  No Home Page </span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
              <label for="brand-name">Icon</label>
              <input type="file" class="dropify" data-height="140" id="input-file-now" name="icon" >
          </div>
          <div class="form-group">
              <label for="category_name">Home Page</label>
