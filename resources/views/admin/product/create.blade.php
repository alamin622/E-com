                    ...
                    <div class="card ">
                        ...
                        <div class="card-body " style="padding: 1.5rem 5rem!important;">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" value="{{ old('name') }}" class="form-control" id="inputEmail3" placeholder="Product Name" required="">
                                </div>
                            </div>
                        <!--
                            <div class="form-group row">
...
-->
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control demo-select2 " name="subcategory_id" id="subcategory_id" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select class="form-control" name="warehouse"  id="warehouse">
                                        <option selected disabled value=" name"> Select Warehouse name </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="unit" value="{{ old('unit') }}" class="form-control" id="inputEmail3" placeholder="Unit" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="code" value="{{ old('code') }}" id="inputEmail3" placeholder="Product Code" required="">
                                    <small>Product Code unique </small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"   class="form-control " value="{{ old('tags') }}"  name="tags" multiple data-role="tagsinput" placeholder="Type and Hit Comma">
                                </div>
                            </div>
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body " style="padding: 1.5rem 5rem!important;">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="color" value="{{ old('color') }}" multiple data-role="tagsinput" class="form-control" id="inputEmail3" placeholder="Color">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Size</label>
                                <div class="col-sm-9">
                                    <input type="text" name="size"  value="{{ old('size') }}" multiple data-role="tagsinput" class="form-control" id="inputEmail3" placeholder="Size">
                                </div>
                            </div>
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body " style="padding: 1.5rem 5rem!important;">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                   <textarea class="textarea" {{ old('description') }} placeholder="Place some text here" name="description"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body " style="padding: 1.5rem 5rem!important;">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="selling_price" value="{{ old('selling_price') }} " class="form-control" required="" placeholder="Selling Price">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="purchase_price" value="{{ old('purchase_price') }}" class="form-control" placeholder="Purchase Price">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Discount price</label>
                                <div class="col-sm-9">
                                    <input type="text" name="discount_price" value=" {{ old('discount_price') }}" class="form-control"  placeholder="Discount Price">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="stock_quantity" value="{{ old('stock_quantity') }}" class="form-control" id="inputEmail3" placeholder="Stock Quantity" required="">
                                </div>
                            </div>
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <small id="emailHelp" class="form-text text-muted">This is your  Thumbnail </small>
                        </div>
                        ...
                        <div class="card ">
                            ...
                            <div class="clone hide" style="display: none;" >
                                <div class="control-group input-group form-group  card-body " style="margin-top:-30px">
                                    <input type="file" accept="image/*" name="images[]" multiple="multiple" class="form-control">
                                    <div class="input-group-btn">
                            ...
                            <div class="card-body">
                                <h6 for="inputEmail3">Features Product</h6>
                                    ...
                                    <div class="bootstrap-switch-container" >
                                        <input type="checkbox" name="featured" value="1" checked data-toggle="toggle">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-secondary">
                            <div class="card-body">
                                ...
                                <div class="bootstrap-switch-container" >
                                    <input type="checkbox" name="today_deal"  value="1" checked data-toggle="toggle">
                                </div>
                            </div>
                        </div>
                        <div class="card card-secondary">
                            <div class="card-body">
                                ...
                                <div class="bootstrap-switch-container" >
                                    <input type="checkbox" name="status" value="1" checked data-toggle="toggle">
                                </div>
                            </div>
                        </div>
                            <div class="card card-secondary">
                                <div class="card-body">
                                    <h6 for="trendy_product">Trendy product</h6>
                                    <div class="bootstrap-switch-container" >
                                        <input type="checkbox" name="trendy_product" value="1"  data-toggle="toggle">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-secondary">
                                <div class="card-body">
                                    ...
                                    <div class="bootstrap-switch-container" >
                                        <input type="checkbox" name="product_slider" value="1"  data-toggle="toggle">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                <input type="text" name="video" value="{{ old('video') }}" class="form-control" id="inputEmail3" placeholder="vedio Embed Code">
                            </div>
                        </div>
